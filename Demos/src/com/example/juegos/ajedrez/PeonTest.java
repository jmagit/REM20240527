...
class PeonTest {
	...
	void setUp() throws Exception {
		...
		tablero.setPieza(3,  1, new Peon(Color.BLANCO));
		tablero.setPieza(3,  2, new Peon(Color.NEGRO));
		tablero.setPieza(2,  2, new Peon(Color.BLANCO));
		tablero.setPieza(2,  3, new Peon(Color.BLANCO));
		
		tablero.setPieza(6,  8, new Peon(Color.NEGRO));
		tablero.setPieza(6,  7, new Peon(Color.BLANCO));
		tablero.setPieza(7,  7, new Peon(Color.NEGRO));
		tablero.setPieza(7,  6, new Peon(Color.NEGRO));
	}
	...
	class Promocionar {
		...
		void EnVertical() throws JuegoException {
			...
			peon.addPromocionaListener(arg -> { arg.setPieza(pieza); });
		...
		void Comiendo() throws JuegoException {
			...
			peon.addPromocionaListener(arg -> { arg.setPieza(pieza); });
			tablero.setPieza(7,  2, peon);
			tablero.setPieza(8,  1, new Peon(Color.NEGRO));
		...
		void Cancelar() throws JuegoException {
			...
			var pieza = new Torre(Color.BLANCO);		
			var peon = new Peon(Color.BLANCO);
			peon.addPromocionaListener(arg -> { arg.setCancel(true); arg.setPieza(pieza); });
			tablero.setPieza(7,  2, peon);
