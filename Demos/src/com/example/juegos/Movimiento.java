...
public class Movimiento {	
	...
	/**
	 * Constructor que recibe la posición inicial y final del movimiento
...
//		if(posicionFinal == posicionInicial)
	...
	/**
	 * Indica la dirección vertical del movimiento
	 * @return -1 de abajo/arriba, 1 de arriba/abajo, 0 estático
	 */
	...
	/**
	 * Indica la dirección horizontal del movimiento
	 * @return -1 de izquierda/derecha, 1 de derecha/izquierda, 0 estático
	 */
